...
class HiLo extends ExtendedGame implements MultiplierCanBeLimited {
  ...
  public function turn(\App\Models\Game $game, array $turnData): Turn {
    ...
    if ($turnData['type'] === 'higher') $multiplier = HouseEdgeModule::apply($this, 12.350 / (13 - ($current['slot'])));
    else if ($turnData['type'] === 'lower') $multiplier = HouseEdgeModule::apply($this, (12.350 / ($current['slot'] - 1)));
