...
class BotNewAccount implements ShouldQueue {
  ...
  public function handle() {
    $user = User::create([
      ...
      'private_bets' => mt_rand(0, 100) <= floatval(Settings::get('Private bets probability', 20)),
      'private_profile' => mt_rand(0, 100) <= floatval(Settings::get('Private profile probability', 20))
    ]);
