          ...
          <div v-if="!isGuest && tab === 1" class="tab-content" data-tab="list">
            <table class="table dt-responsive nowrap dataTable"
              ...
              <router-link tag="tr" :to="`/profile/${affiliate.user._id}`" v-for="affiliate in affiliates.affiliates"
                ...
                <td><img alt :src="affiliate.user.avatar" style="width: 32px; height: 32px; margin-right: 5px;">
                  {{ affiliate.user.name }}
                </td>
            ...
            <div v-else style="text-align: center">You don't have any affiliates yet.</div>
          </div>
