        ...
        <div class="content">
            ...
            <div class="row">
                <div class="col-6">
                    ...
                    <span>{{ wager.toFixed(currency.startsWith('local_') ? 2 : 8) }}</span> <web-icon :icon="currencies[currency].icon" :style="{ color: currencies[currency].style }"></web-icon>
                </div>
                <div class="col-6">
                    <div>{{ $t('general.profit_monitoring.profit') }}</div>
                    <span>{{ profit.toFixed(this.currency.startsWith('local_') ? 2 : 8) }}</span> <web-icon :icon="currencies[currency].icon" :style="{ color: currencies[currency].style }"></web-icon>
                </div>
            </div>
        </div>
    </div>
