  ...
  export default {
    ...
    methods: {
      ...
      setCard(card) {
        ...
        this.startingCardIndex = window._.findKey(deck, card);
      ...
      recalculateMultipliers() {
        let calculateMultiplier = (type) => {
          if(type === 'higher') return parseFloat(this.applyHouseEdge(12.350 / (13 - (deck[this.startingCardIndex].slot))));
          if(type === 'lower') return parseFloat(this.applyHouseEdge(12.350 / (deck[this.startingCardIndex].slot - 1)));
      ...
      restore(game) {
        ...
        window._.forEach(game.history, (index) => this.addToHistory(deck[index]));
