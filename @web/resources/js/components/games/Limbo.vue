    ...
    <div class="limbo-footer">
      <div class="row">
        <div class="col-6 pr-2">
          ...
          <input class="mt-3" type="number" v-model="target_payout" step=".01" :placeholder="$t('general.target_payout')">
        </div>
        <div class="col-6 pl-2">
          <div>{{ $t('general.win_chance') }}</div>
          <input class="mt-3" type="number" v-model="win_chance" value="50.00" step=".01" :placeholder="$t('general.win_chance')">
        </div>
      </div>
    </div>
  </div>
