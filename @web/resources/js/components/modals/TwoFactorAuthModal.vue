      ...
      open(error, resolve, reject) {
        ...
        if ($('.xmodal.tfa').length === 0) Bus.$emit('modal:new', {
          ...
          component: {
            ...
            mounted() {
              document.querySelector('.inputs input:first-child').focus();
            },
            template: `
                <div>
                ...
                <div class="inputs" :class="'input' + value.length">
                ...
                <div class="tfaStatus">
                  {{ disabled ? '...' : $t('general.profile.2fa_digits', {'digits': 6 - value.length}) }}
                </div>
                </div>`
          }
        });
...
<style lang="scss">
  ...
  .xmodal.tfa {
    ...
    .inputs {
      ...
      &.input0 input:nth-child(1), &.input1 input:nth-child(2), &.input2 input:nth-child(3),
      &.input3 input:nth-child(4), &.input4 input:nth-child(5), &.input5 input:nth-child(6) {
        @include themed() {
